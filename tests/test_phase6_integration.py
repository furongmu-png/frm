...
class TestMCPPhase6:
    def test_total_tool_count(self, mcp_server):
        """Server should now have at least 71 tools (16 base + 6 emergence +
        12 Phase 6 + 6 Audio + 7 Graph + 10 Robotics + 7 Time + 7 Code +
        future Phase 7 domains). Each Phase 7 domain adds its own tools;
        this assertion only verifies the floor — see
